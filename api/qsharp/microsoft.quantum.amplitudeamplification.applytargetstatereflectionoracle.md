...
---
# <a name="applytargetstatereflectionoracle-operation"></a>ApplyTargetStateReflectionOracle, operacja
...
Implementacja programu <xref:microsoft.quantum.canon.targetstatereflectionoracle> .
