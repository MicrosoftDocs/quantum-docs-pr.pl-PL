...
ms.locfileid: "96190755"
---
# <a name="applyphaseleoperationonlea-operation"></a>ApplyPhaseLEOperationOnLEA, operacja
...
### <a name="op--phaselittleendian--unit--is-adj"></a>op: [PhaseLittleEndian](xref:Microsoft.Quantum.Arithmetic.PhaseLittleEndian) => [Jednostka](xref:microsoft.quantum.lang-ref.unit) PhaseLittleEndian jest korektą
