...
title: ApplyPhaseLEOperationOnLEC, operacja
...
ms.locfileid: "92721533"
---
# <a name="applyphaseleoperationonlec-operation"></a>ApplyPhaseLEOperationOnLEC, operacja
...
### <a name="op--phaselittleendian--unit-ctl"></a>op: [PhaseLittleEndian](xref:Microsoft.Quantum.Arithmetic.PhaseLittleEndian) => [jednostki](xref:microsoft.quantum.lang-ref.unit) CTL
