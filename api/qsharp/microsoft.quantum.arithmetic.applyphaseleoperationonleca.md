...
ms.locfileid: "98843627"
---
# <a name="applyphaseleoperationonleca-operation"></a>ApplyPhaseLEOperationOnLECA, operacja
...
### <a name="op--phaselittleendian--unit--is-adj--ctl"></a>op: [PhaseLittleEndian](xref:Microsoft.Quantum.Arithmetic.PhaseLittleEndian) => [Unit](xref:microsoft.quantum.lang-ref.unit)  to przymiotnik + CTL
