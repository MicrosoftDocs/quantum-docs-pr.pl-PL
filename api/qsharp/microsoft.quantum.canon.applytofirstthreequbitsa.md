...
### <a name="op--qubitqubitqubit--unit-adj"></a>op: ([qubit](xref:microsoft.quantum.lang-ref.qubit),[qubit](xref:microsoft.quantum.lang-ref.qubit),[qubit](xref:microsoft.quantum.lang-ref.qubit)) => korekta [jednostki](xref:microsoft.quantum.lang-ref.unit)
