...
---
# <a name="inplacemajority-operation"></a>InPlaceMajority, operacja
...
> [!WARNING]
> InPlaceMajority jest przestarzała. Użyj <xref:Microsoft.Quantum.Arithmetic.ApplyMajorityInPlace> zamiast tego.
>
> Używaj @"microsoft.quantum.arithmetic.applymajorityinplace".
