...
ms.locfileid: "92716095"
---
# <a name="inplacexorbe-operation"></a>InPlaceXorBE, operacja
...
> [!WARNING]
> InPlaceXorBE jest przestarzała. Użyj <xref:ApplyReversedOpLECA(ApplyXorInPlace(value, _), target)> zamiast tego.
>
> Ta operacja została usunięta.
...
### <a name="target--bigendian"></a>obiekt docelowy: [BigEndian](xref:Microsoft.Quantum.Arithmetic.BigEndian)
