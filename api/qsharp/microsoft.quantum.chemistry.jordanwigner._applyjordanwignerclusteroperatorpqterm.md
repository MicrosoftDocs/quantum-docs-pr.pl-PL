...
---
# <a name="_applyjordanwignerclusteroperatorpqterm-operation"></a>Operacja _ApplyJordanWignerClusterOperatorPQTerm
...
Stosuje ewolucję czasową przez operator klastra PQ termin opisany przez `GeneratorIndex` .
...
`GeneratorIndex` reprezentujący termin PQ operatora klastra.
