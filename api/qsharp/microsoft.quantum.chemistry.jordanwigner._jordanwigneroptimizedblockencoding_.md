...
ms.locfileid: "96215694"
---
# <a name="_jordanwigneroptimizedblockencoding_-function"></a>_JordanWignerOptimizedBlockEncoding_ , funkcja
...
## <a name="output--intintdoubleblockencodingreflection"></a>Wynik: (([int](xref:microsoft.quantum.lang-ref.int),[int](xref:microsoft.quantum.lang-ref.int)), ([Double](xref:microsoft.quantum.lang-ref.double),[BlockEncodingReflection](xref:Microsoft.Quantum.Simulation.BlockEncodingReflection)))
