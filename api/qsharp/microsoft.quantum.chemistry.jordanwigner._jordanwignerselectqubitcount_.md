...
---
# <a name="_jordanwignerselectqubitcount_-function"></a>_JordanWignerSelectQubitCount_ , funkcja
...
## <a name="output--intintintintintint"></a>Wynik: ([int](xref:microsoft.quantum.lang-ref.int), ([int](xref:microsoft.quantum.lang-ref.int),[int](xref:microsoft.quantum.lang-ref.int),[int](xref:microsoft.quantum.lang-ref.int),[int](xref:microsoft.quantum.lang-ref.int),[int](xref:microsoft.quantum.lang-ref.int)[]))
