...
---
# <a name="_mergetworegisters_-operation"></a>_MergeTwoRegisters_ , operacja
...
### <a name="oracle--qubitqubit--unit--is-adj--ctl"></a>Oracle: ([qubit](xref:microsoft.quantum.lang-ref.qubit)[],[qubit](xref:microsoft.quantum.lang-ref.qubit)[]) => [Unit](xref:microsoft.quantum.lang-ref.unit)  to przymiotnik + CTL
