...
ms.locfileid: "96214096"
---
# <a name="intasdouble-function"></a>IntAsDouble, funkcja
...
Konwertuje daną liczbę całkowitą na równoważną liczbę zmiennoprzecinkową o podwójnej precyzji.
...
Aby uzyskać więcej informacji, zobacz [C# Convert. ToDouble —](https://docs.microsoft.com/dotnet/api/system.convert.todouble?view=netframework-4.7.1#System_Convert_ToDouble_System_Int64_) .