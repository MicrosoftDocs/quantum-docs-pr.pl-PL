...
ms.locfileid: "96200156"
---
# <a name="parity-function"></a>Funkcja parzystości

Przestrzeń nazw: [Microsoft. Quantum. Extensions. bitowe](xref:Microsoft.Quantum.Extensions.Bitwise)

Pakiet: [Microsoft. Quantum. QSharp. Core](https://nuget.org/packages/Microsoft.Quantum.QSharp.Core)


> [!WARNING]
> Parzystość była przestarzała. Użyj <xref:Microsoft.Quantum.Bitwise.Parity> zamiast tego.
>
> Używaj @"microsoft.quantum.bitwise.parity".
