...
ms.locfileid: "98823067"
---
# <a name="dumpmachine-function"></a>DumpMachine, funkcja

Przestrzeń nazw: [Microsoft. Quantum. Extensions. Diagnostics](xref:Microsoft.Quantum.Extensions.Diagnostics)

Pakiet: [Microsoft. Quantum. QSharp. Core](https://nuget.org/packages/Microsoft.Quantum.QSharp.Core)


> [!WARNING]
> DumpMachine jest przestarzała. Użyj <xref:Microsoft.Quantum.Diagnostics.DumpMachine> zamiast tego.
>
> Używaj @"microsoft.quantum.diagnostics.dumpmachine".
