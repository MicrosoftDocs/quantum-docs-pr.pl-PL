...
ms.locfileid: "98849483"
---
# <a name="assertqubittol-operation"></a>AssertQubitTol, operacja

Przestrzeń nazw: [Microsoft. Quantum. Extensions. Testowanie](xref:Microsoft.Quantum.Extensions.Testing)

Pakiet: [Microsoft. Quantum. QSharp. Core](https://nuget.org/packages/Microsoft.Quantum.QSharp.Core)


> [!WARNING]
> AssertQubitTol jest przestarzała. Użyj <xref:Microsoft.Quantum.Diagnostics.AssertQubitWithinTolerance> zamiast tego.
>
> Używaj @"microsoft.quantum.diagnostics.assertqubitwithintolerance".
