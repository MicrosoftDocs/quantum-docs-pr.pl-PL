...
---
# <a name="assertprob-operation"></a>AssertProb, operacja
...
> [!WARNING]
> AssertProb jest przestarzała. Użyj <xref:Microsoft.Quantum.Diagnostics.AssertMeasurementProbability> zamiast tego.
