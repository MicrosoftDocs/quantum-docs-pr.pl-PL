...
ms.locfileid: "98844462"
---
# <a name="_encodesample-function"></a>Funkcja _EncodeSample
...
### <a name="sample--labeledsample"></a>przykład: [LabeledSample](xref:Microsoft.Quantum.MachineLearning.LabeledSample)





## <a name="output--labeledsamplestategenerator"></a>Dane wyjściowe: ([LabeledSample](xref:Microsoft.Quantum.MachineLearning.LabeledSample),[StateGenerator](xref:Microsoft.Quantum.MachineLearning.StateGenerator))
