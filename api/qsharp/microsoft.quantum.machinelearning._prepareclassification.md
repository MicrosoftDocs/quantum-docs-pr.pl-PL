...
title: Operacja _PrepareClassification
...
ms.locfileid: "98846125"
---
# <a name="_prepareclassification-operation"></a>Operacja _PrepareClassification
...
### <a name="encoder--littleendian--unit--is-adj--ctl"></a>koder: [LittleEndian](xref:Microsoft.Quantum.Arithmetic.LittleEndian) => [Unit](xref:microsoft.quantum.lang-ref.unit)  to przymiotnik + CTL
