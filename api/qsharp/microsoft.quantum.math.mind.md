...
ms.locfileid: "92711251"
---
# <a name="mind-function"></a>Funkcja myśli
...
Zwraca mniejsze z dwóch podanych liczb.
...
Aby uzyskać więcej informacji, zobacz [System. Math. min](https://docs.microsoft.com/dotnet/api/system.math.min) .