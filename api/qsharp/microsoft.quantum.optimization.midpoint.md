...
---
# <a name="midpoint-function"></a>Funkcja punktu środkowego
...
Zwraca punkt środkowy dla interwału.
...
### <a name="left--double"></a>lewy: [Podwójna](xref:microsoft.quantum.lang-ref.double)




### <a name="right--double"></a>prawy: [Double](xref:microsoft.quantum.lang-ref.double)
