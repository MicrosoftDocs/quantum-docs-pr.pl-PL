...
---
# <a name="_quantumromdiscretization-function"></a>Funkcja _QuantumROMDiscretization
...
## <a name="output--doubleintint"></a>Wynik: ([Double](xref:microsoft.quantum.lang-ref.double),[int](xref:microsoft.quantum.lang-ref.int)[],[int](xref:microsoft.quantum.lang-ref.int)[])
