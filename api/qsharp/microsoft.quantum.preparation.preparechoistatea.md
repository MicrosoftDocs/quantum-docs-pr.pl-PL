...
---
# <a name="preparechoistatea-operation"></a>PrepareChoiStateA, operacja
...
Przygotowuje stan Choi – Jamiołkowski dla danej operacji z elementem sąsiednim dla danego odwołania i rejestrów docelowych.
