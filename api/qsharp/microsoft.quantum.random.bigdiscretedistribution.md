...
title: BigDiscreteDistribution typ zdefiniowany przez użytkownika
...
ms.locfileid: "92722852"
---
# <a name="bigdiscretedistribution-user-defined-type"></a>BigDiscreteDistribution typ zdefiniowany przez użytkownika
...
Reprezentuje rozkład prawdopodobieństwa univariate z liczbą całkowitą dowolnego rozmiaru.
...
### <a name="sample--unit--bigint"></a>Przykład: [Jednostka](xref:microsoft.quantum.lang-ref.unit) => [bigint](xref:microsoft.quantum.lang-ref.bigint) 
