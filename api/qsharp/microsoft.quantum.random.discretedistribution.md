...
---
# <a name="discretedistribution-user-defined-type"></a>DiscreteDistribution typ zdefiniowany przez użytkownika
...
Reprezentuje rozkład prawdopodobieństwa univariate za pośrednictwem liczb całkowitych.
...
### <a name="sample--unit--int"></a>Przykład: [Jednostka](xref:microsoft.quantum.lang-ref.unit) => [int](xref:microsoft.quantum.lang-ref.int) 
