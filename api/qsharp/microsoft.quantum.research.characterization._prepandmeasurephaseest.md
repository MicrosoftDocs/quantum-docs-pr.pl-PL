...
---
# <a name="_prepandmeasurephaseest-operation"></a>Operacja _PrepAndMeasurePhaseEst
...
### <a name="op--doubledoublequbit--unit"></a>op: ([Double](xref:microsoft.quantum.lang-ref.double),[Double](xref:microsoft.quantum.lang-ref.double),[qubit](xref:microsoft.quantum.lang-ref.qubit)) = [Jednostka](xref:microsoft.quantum.lang-ref.unit)> 
