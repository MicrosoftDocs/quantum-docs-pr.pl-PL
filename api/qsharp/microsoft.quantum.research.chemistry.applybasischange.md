...
---
# <a name="applybasischange-operation"></a>ApplyBasisChange, operacja
...
### <a name="ops--qubit--unit--is-adj--ctl"></a>Ops: [qubit](xref:microsoft.quantum.lang-ref.qubit) => [Unit](xref:microsoft.quantum.lang-ref.unit)  to przymiotnik + CTL []
