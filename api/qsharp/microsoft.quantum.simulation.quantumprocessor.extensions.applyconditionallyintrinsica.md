...
### <a name="onequalop--unit--unit--is-adj"></a>onEqualOp: [](xref:microsoft.quantum.lang-ref.unit) => [Jednostka](xref:microsoft.quantum.lang-ref.unit) jednostki jest korektą




### <a name="onnonequalop--unit--unit--is-adj"></a>onNonEqualOp: [](xref:microsoft.quantum.lang-ref.unit) => [Jednostka](xref:microsoft.quantum.lang-ref.unit) jednostki jest korektą
