...
### <a name="onresultzeroop--t--unit-adj--ctl"></a>onResultZeroOp: 'T => skorygowania [jednostki](xref:microsoft.quantum.lang-ref.unit) + CTL
...
### <a name="onresultoneop--u--unit-adj--ctl"></a>onResultOneOp: ' U => korekta [jednostki](xref:microsoft.quantum.lang-ref.unit) + CTL
