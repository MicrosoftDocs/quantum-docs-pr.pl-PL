...
Rozważ chwilę przekształcenie jednostkowe $ \text { CNOT } _ { 01 } (H \otimes 1) $ .
...
jest obsługiwanie macierzy jednostkowej $ $ .
...
zapewnia bramie sterowanej klasycznym, gdzie $ G $ jest zastosowany w przypadku, gdy jest to wartość $ 1 $ .
