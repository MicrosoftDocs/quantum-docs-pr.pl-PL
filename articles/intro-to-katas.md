...
ms.locfileid: "83660755"
---
# <a name="learn-quantum-computing-with-the-quantum-katas"></a>Nauka wykonywania obliczeń kwantowych z artykułów Quantum Kata

[Artykuły Quantum Kata](https://github.com/Microsoft/QuantumKatas/) to zbiór materiałów typu open source, zawierający realizowane samodzielnie samouczki i zestawy ćwiczeń programistycznych, które służą zarówno do nauki elementów obliczeń kwantowych, jak i programowania w języku Q#.
...
Poniżej przedstawiono podsumowanie głównych tematów uwzględnionych w artykułach Quantum Kata. Zalecamy, aby na początku postępować zgodnie z tą ścieżką szkoleniową w celu zapewnienia, że dobrze opanujesz podstawowe koncepcje obliczeń kwantowych. Oczywiście możesz pominąć znane sobie tematy, na przykład arytmetykę zespoloną, i poznawać algorytmy w dowolnej kolejności.
...
* [Rozpoznawanie bramek kwantowych](https://github.com/microsoft/QuantumKatas/tree/master/BasicGates)
* [Tworzenie superpozycji kwantowej](https://github.com/microsoft/QuantumKatas/tree/master/Superposition)
* [Rozróżnianie stanów kwantowych przy użyciu pomiarów](https://github.com/microsoft/QuantumKatas/tree/master/Measurements)
* [Wspólne pomiary](https://github.com/microsoft/QuantumKatas/tree/master/JointMeasurements)
...
* [Protokół BB84 do dystrybucji kluczy kwantowych](https://github.com/microsoft/QuantumKatas/tree/master/KeyDistribution_BB84)
* Naprawianie błędów kwantowych: [kod naprawczy dla błędu przerzucania bitów](https://github.com/microsoft/QuantumKatas/tree/master/QEC_BitFlipCode)
* [Szacowanie fazy](https://github.com/microsoft/QuantumKatas/blob/master/PhaseEstimation)
* Arytmetyka kwantowa: [tworzenie sumatorów z przeniesieniami szeregowymi](https://github.com/microsoft/QuantumKatas/blob/master/RippleCarryAdder)
