...
Gdy wszystko będzie gotowe do wzięcia udziału w pracy, Wyślij żądanie ściągnięcia za pośrednictwem usługi GitHub do odpowiedniego repozytorium.
Zespół sprawdzi i dostarczy opinię. Wszystkie komentarze muszą zostać odebrane i rozwiązane, a wszystkie testy muszą zostać przekazane przed scaleniem kodu z `main` gałęzią.
...
Poprosimy również o wprowadzenie zmian w żądaniu ściągnięcia, jeśli wymaga to więcej dokumentacji lub testów jednostkowych, aby pomóc nam w jego użyciu lub jeśli jest ona zależna od stylu od pozostałej części Q# bibliotek, które utrudniają użytkownikom znalezienie funkcji.
...
Aby dowiedzieć się więcej, przejdź do poniższej wskazówki dotyczącej Q# stylu.

> [!div class="nextstepaction"]
> [Informacje na temat Q# wytycznych dotyczących stylu](xref:microsoft.quantum.contributing.style)
