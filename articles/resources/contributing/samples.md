...
Przeglądając pliki wchodzące w skład każdego folderu, przyjrzyjmy się do [`algorithms/chsh-game/`](https://github.com/microsoft/Quantum/tree/master/samples/algorithms/chsh-game) przykładu.
