...
ms.locfileid: "98856641"
---
# <a name="third-party-software-notices-and-information"></a>POWIADOMIENIA I INFORMACJE DOTYCZĄCE OPROGRAMOWANIA INNYCH FIRM

Ten plik jest oparty na materiałach lub zakupionych w nim z projektów wymienionych poniżej (adres IP innej firmy). Oryginalne informacje o prawach autorskich i licencję, na podstawie których firma Microsoft otrzymała ten adres IP innej firmy, zostały przedstawione poniżej. Takie licencje i powiadomienia są udostępniane wyłącznie w celach informacyjnych. Firma Microsoft udziela licencji na adres IP innej firmy w ramach postanowień licencyjnych dotyczących produktu firmy Microsoft. Firma Microsoft zastrzega sobie wszelkie pozostałe prawa, które nie zostały wyraźnie przyznane zgodnie z niniejszą umową, niezależnie od tego, czy są one zgodne, drodze estoppelu czy też
...
8. xUnit. analizatory 0.7.0 (https://www.nuget.org/packages/xunit.analyzers/0.7.0)
...
## <a name="xunitrunnervisualstudio-notices-and-information"></a>xUnit. Runner. VisualStudio — uwagi i informacje
---------------------------------------
Prawa autorskie (c) .NET Foundation i współautorzy wszystkie prawa zastrzeżone

Licencjonowane w ramach licencji Apache, wersja 2,0 ("Licencja"); nie można używać tego pliku z wyjątkiem zgodności z licencją.
Licencjobiorca może uzyskać kopię licencji w

 [http://www.apache.org/licenses/LICENSE-2.0](http://www.apache.org/licenses/LICENSE-2.0)

O ile nie jest to wymagane przez prawo prawne ani uzgodnione na piśmie, oprogramowanie rozproszone w ramach licencji jest dystrybuowane na "AS", bez udzielania jakichkolwiek gwarancji lub warunków jakiegokolwiek rodzaju.
Zobacz licencję dla określonego języka, w którym znajdują się uprawnienia i ograniczenia w ramach licencji.



## <a name="xunitrunnerconsole-notices-and-information"></a>xUnit. Runner. uwagi dotyczące konsoli i informacje
---------------------------------------
Prawa autorskie (c) .NET Foundation i współautorzy wszystkie prawa zastrzeżone
...
## <a name="xunitextensibilitycore-notices-and-information"></a>xUnit. rozszerzalność. podstawowe powiadomienia i informacje
---------------------------------------
Prawa autorskie (c) .NET Foundation i współautorzy wszystkie prawa zastrzeżone
...
## <a name="xunitcore-notices-and-information"></a>xUnit. Core — uwagi i informacje
---------------------------------------
Prawa autorskie (c) .NET Foundation i współautorzy wszystkie prawa zastrzeżone
...
## <a name="xunitassert-notices-and-information"></a>xUnit. potwierdzenia i informacje
---------------------------------------
Prawa autorskie (c) .NET Foundation i współautorzy wszystkie prawa zastrzeżone
...
## <a name="xunitanalyzers-notices-and-information"></a>POWIADOMIENIA i informacje xUnit. analizatory
---------------------------------------
Prawa autorskie (c) .NET Foundation i współautorzy wszystkie prawa zastrzeżone
...
## <a name="xunitabstractions-notices-and-information"></a>xUnit. abstrakcje — uwagi i informacje
---------------------------------------
Prawa autorskie (c) .NET Foundation i współautorzy wszystkie prawa zastrzeżone
...
## <a name="xunit-notices-and-information"></a>POWIADOMIENIA i informacje xUnit
---------------------------------------
Prawa autorskie (c) .NET Foundation i współautorzy wszystkie prawa zastrzeżone
...
## <a name="managedesent-notices-and-information"></a>POWIADOMIENIA i informacje ManagedEsent
---------------------------------------
Licencja publiczna firmy Microsoft (MS-PL)

Ta licencja reguluje korzystanie z towarzyszącego oprogramowania. W przypadku korzystania z oprogramowania akceptujesz tę licencję. Jeśli licencja nie zostanie zaakceptowana, nie używaj oprogramowania.

1. Definicje

Warunki "reprodukowanie", "reprodukcja", "" pochodne działania "i" dystrybucja "mają takie samo znaczenie jak w przypadku prawa autorskiego Stanów Zjednoczonych.

"Udział" to oryginalne oprogramowanie lub wszelkie dodatki lub zmiany w oprogramowaniu.

"Współautor" to każda osoba, która dystrybuuje swój wkład w ramach tej licencji.

"Licencjonowane patenty" to oświadczenia patentowe współautora, które zostały odczytane bezpośrednio z udziału.
...
(A) Brak licencji na znaki towarowe — ta licencja nie przyznaje praw do korzystania z nazw, logo ani znaków towarowych współautorów.

(B) w przypadku zgłoszenia patentu do jakiegokolwiek współautora w ramach patentów, które zostały wniesione przez oprogramowanie, licencja patentowa od tego współautor do oprogramowania zostaje automatycznie zakończona.

(C) w przypadku dystrybucji jakiejkolwiek części oprogramowania należy zachować wszystkie prawa autorskie, patentowe, znaki towarowe i informacje o tym, które są obecne w oprogramowaniu.
...
## <a name="fsharpcharting-notices-and-information"></a>FSharp. Tworzenie wykresów — powiadomienia i informacje
---------------------------------------
Licencja MIT (MIT)
...
## <a name="fscheck-notices-and-information"></a>POWIADOMIENIA i informacje FsCheck
---------------------------------------
...
## <a name="fparsec-notices-and-information"></a>POWIADOMIENIA i informacje FParsec
---------------------------------------
