---
title: 'Konwersje typów w :::no-loc(Q#)::: bibliotekach standardowych'
description: 'Poznaj typowe i zdefiniowane przez użytkownika funkcje konwersji typów w :::no-loc(Q#)::: bibliotekach standardowych.'
author: cgranade
...
<span data-ttu-id="bb9ea-104">:::no-loc(Q#)::: jest językiem o **jednoznacznie określonym typie** .</span><span class="sxs-lookup"><span data-stu-id="bb9ea-104">:::no-loc(Q#)::: is a **strongly-typed** language.</span></span>
<span data-ttu-id="bb9ea-105">W szczególności nie :::no-loc(Q#)::: rzutuje niejawnie między różnymi typami.</span><span class="sxs-lookup"><span data-stu-id="bb9ea-105">In particular, :::no-loc(Q#)::: does not implicitly cast between distinct types.</span></span> <span data-ttu-id="bb9ea-106">Na przykład `1 + 2.0` nie jest prawidłowym :::no-loc(Q#)::: wyrażeniem.</span><span class="sxs-lookup"><span data-stu-id="bb9ea-106">For instance, `1 + 2.0` is not a valid :::no-loc(Q#)::: expression.</span></span>
<span data-ttu-id="bb9ea-107">Zamiast tego :::no-loc(Q#)::: oferuje różne funkcje konwersji typów do konstruowania nowych wartości danego typu.</span><span class="sxs-lookup"><span data-stu-id="bb9ea-107">Rather, :::no-loc(Q#)::: provides a variety of type conversion functions for constructing new values of a given type.</span></span>
...
<span data-ttu-id="bb9ea-112">Na koniec :::no-loc(Q#)::: Biblioteka standardowa zawiera wiele typów zdefiniowanych przez użytkownika, takich jak <xref:Microsoft.Quantum.Math.Complex> i <xref:Microsoft.Quantum.Arithmetic.LittleEndian> .</span><span class="sxs-lookup"><span data-stu-id="bb9ea-112">Finally, the :::no-loc(Q#)::: standard library provides a number of user-defined types such as <xref:Microsoft.Quantum.Math.Complex> and <xref:Microsoft.Quantum.Arithmetic.LittleEndian>.</span></span>
