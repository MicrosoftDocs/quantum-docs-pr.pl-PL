...
Należy zwrócić uwagę na wyniki każdego pomiaru przez znak eigenvalue, który jest zaobserwowany, albo $ + $ lub $-$, odpowiadający `Result` wartościom Q # `Zero` i `One` , odpowiednio.
