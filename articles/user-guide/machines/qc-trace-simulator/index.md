...
<span data-ttu-id="1c5f0-111">Za pomocą symulatora śledzenia kwantowego można uruchomić dowolną operację w języku Q#.</span><span class="sxs-lookup"><span data-stu-id="1c5f0-111">You can use the quantum trace simulator to run any Q# operation.</span></span>
